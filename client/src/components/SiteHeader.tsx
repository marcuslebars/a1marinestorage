...
// Style: Contemporary Coastal Modernism — dark harbor, cyan accents, sticky nav with backdrop blur
          ...
          {navLinks.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "text-sm font-medium transition-colors duration-200 hover:text-[oklch(0.85_0.18_195)]",
                  isActive
        ...
        <div className="border-t border-white/10 bg-[oklch(0.12_0.018_240)]/98 backdrop-blur-xl md:hidden">
          <nav className="container flex flex-col gap-1 py-4 max-w-7xl mx-auto">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "text-[oklch(0.85_0.18_195)] bg-white/5"
            ...
            <div className="mt-2 pt-2 border-t border-white/10">
              <Button
                asChild
                className="w-full bg-[oklch(0.85_0.18_195)] text-[oklch(0.12_0.018_240)] font-semibold hover:bg-[oklch(0.78_0.18_195)]"
              >
                <Link href="/calculator">Get Storage Quote</Link>
              </Button>
            </div>
