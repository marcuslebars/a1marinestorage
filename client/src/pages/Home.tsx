      ...
      <section className="relative flex min-h-screen items-center overflow-hidden bg-black">
        ...
        <div className="container max-w-7xl mx-auto relative z-10 flex min-h-screen items-center py-24">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[oklch(0.85_0.18_195)] mb-6">
            ...
            >
              ...
              <span className="text-[oklch(0.85_0.18_195)]">a Safe Winter.</span>
            </h1>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              {["Gated & Secured Facility", "Georgian Bay Area", "Sister Company of A1 Marine Care"].map((badge) => (
                ...
                >
                  <CheckCircle2 className="h-3.5 w-3.5 text-[oklch(0.85_0.18_195)]" />
                  {badge}
                </span>
              ))}
            </div>
          ...
          >
              ...
              {services.map((service, i) => {
                ...
                return (
                  <Link key={service.title} href={service.href}>
                    <div
                      className="group marine-card overflow-hidden cursor-pointer hover:border-[oklch(0.85_0.18_195)/30] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_-20px_oklch(0.85_0.18_195/0.2)]"
                    ...
                    >
                      ...
                      {!service.img && (
                        <div className="h-44 bg-gradient-to-br from-[oklch(0.20_0.02_240)] to-[oklch(0.14_0.015_240)] flex items-center justify-center">
                          <Icon className="h-16 w-16 text-[oklch(0.85_0.18_195)/30]" />
                        </div>
                      )}
                      <div className="p-5">
                        <div className="flex items-center gap-2.5 mb-3">
                          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[oklch(0.85_0.18_195)/10]">
                            <Icon className="h-4 w-4 text-[oklch(0.85_0.18_195)]" />
                          </div>
            ...
            <div className="mt-10 text-center">
              <Button
                asChild
                variant="outline"
                className="border-white/20 text-white/80 hover:border-[oklch(0.85_0.18_195)] hover:text-[oklch(0.85_0.18_195)] transition-all"
              >
                <Link href="/services">
                  View All Services
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              <div>
                ...
                <div className="space-y-5">
                  {whyPoints.map((point, i) => (
                    <div key={i} className="flex gap-4">
                      <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[oklch(0.85_0.18_195)/10] mt-0.5">
                        <span
                          className="text-sm font-black text-[oklch(0.85_0.18_195)]"
                          style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
                        >
                          {i + 1}
                        </span>
                ...
                <div className="mt-10">
                  <Button
                    asChild
                    className="bg-[oklch(0.85_0.18_195)] text-[oklch(0.12_0.018_240)] font-semibold hover:bg-[oklch(0.78_0.18_195)] btn-cyan-glow active:scale-[0.97] transition-all duration-150"
                  >
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -left-4 marine-card p-4 max-w-[200px]">
                  <div className="flex items-center gap-1.5 mb-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="h-3.5 w-3.5 fill-[oklch(0.85_0.18_195)] text-[oklch(0.85_0.18_195)]" />
                    ))}
                  </div>
